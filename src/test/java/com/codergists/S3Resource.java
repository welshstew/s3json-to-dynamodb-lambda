...
public class S3Resource implements QuarkusTestResourceLifecycleManager {
    ...
    private final static String BUCKET_NAME = "quarkus.s3.quickstart";
    ...
    public Map<String, String> start() {
        ...
        try {
            ...
            PutObjectRequest request = PutObjectRequest.builder()
                                        ...
                                        .build();
            client.putObject(request, RequestBody.fromFile(new File(getClass().getClassLoader().getResource("guava.json").getFile())));
